...
void aggregate_maindet_AT_2_color(){
...
//      if(run[plt]==4128){
//for C 1%
//      if(run[plt]>=4131&&run[plt]<=4132){
      if((run[plt]>=4126&&run[plt]<=4127)||run[plt]==4128||(run[plt]>=4131&&run[plt]<=4132)){
